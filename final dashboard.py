...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
        ...
        figure=px.bar(
        average_sales,
        x='Vehicle_Type',  # 确保 'Vehicle_Type' 列在 average_sales 中
        y='Automobile_Sales',
        title="Sales based on vehicle type"
        )   
) 
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
	...
	# Hint:Use Vehicle_Type and Advertising_Expenditure columns
        ...
        R_chart3 = dcc.Graph(
            ...
            names='Vehicle_Type',
            title='Total advertising expenditure based on vehicle type during recession')
        )
